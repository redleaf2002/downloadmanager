...
public class Constants {
    ...
    public static final String ACTION_RETRY = "com.leaf.downloads.action.DOWNLOAD_WAKEUP";

    /** the intent that gets sent when clicking a successful download */
    public static final String ACTION_OPEN = "com.leaf.downloads.action.DOWNLOAD_OPEN";

    /** the intent that gets sent when clicking an incomplete/failed download  */
    public static final String ACTION_LIST = "com.leaf.downloads.action.DOWNLOAD_LIST";
    ...
    public static final String ACTION_HIDE = "com.leaf.downloads.action.DOWNLOAD_HIDE";
