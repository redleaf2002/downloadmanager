...
public final class Downloads {
    ...
    public static final class Impl implements BaseColumns {
        ...
        public static final String AUTHORITIES = "leaf_downloads";
        ...
        public static final String ACTION_DOWNLOAD_COMPLETED =
                "com.leaf.downloads.action.DOWNLOAD_COMPLETED";
        ...
        /**
         * The name of the column containing the Icon URI of the data being downloaded.
         * <P>Type: TEXT</P>
         * <P>Owner can Init/Read</P>
         */
